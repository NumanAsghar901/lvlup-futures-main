              ...
              <div className="lvf-s01-banner-row">
                <div className="lvf-s01-offer">
                  ...
                  <span className="lvf-s01-offer-full">
                    <span className="lvf-s01-offer-hl">20% off</span> all Evaluations
                  </span>
                  <span className="lvf-s01-offer-short">20% off</span>
                </div>

                <div className="lvf-s01-code">
                  <span className="lvf-s01-code-chip"><b>SEPTEMBER</b></span>
                  <button className="lvf-s01-copy" type="button" data-lvf-copy="SEPTEMBER">
                    <span className="lvf-sr" data-lvf-copy-label="true">Copy discount code SEPTEMBER</span>
