      ...
      <ul className="lvaf-stats">
        <li className="lvaf-stat">
          <span className="lvaf-stat-row">
            <img className="lvaf-stat-ico" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-gift.webp" alt aria-hidden="true" width={26} height={27} loading="lazy" decoding="async" />
        ...
        <li className="lvaf-stat">
          <span className="lvaf-stat-row">
            <img className="lvaf-stat-ico" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-calendar.webp" alt aria-hidden="true" width={26} height={26} loading="lazy" decoding="async" />
        ...
        <li className="lvaf-stat">
          <span className="lvaf-stat-row">
            <img className="lvaf-stat-ico" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-vault.webp" alt aria-hidden="true" width={26} height={26} loading="lazy" decoding="async" />
        ...
        <li className="lvaf-stat">
          <span className="lvaf-stat-row">
            <img className="lvaf-stat-ico" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-retainer.webp" alt aria-hidden="true" width={26} height={27} loading="lazy" decoding="async" />
    ...
    <div className="lvaf-shell lvaf-part-in">
      ...
      <div className="lvaf-cards">
        <article className="lvaf-card">
          ...
          <span className="lvaf-ibox" aria-hidden="true"><img src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-gift.webp" alt width={30} height={31} loading="lazy" decoding="async" /></span>
        ...
        <article className="lvaf-card">
          ...
          <span className="lvaf-ibox" aria-hidden="true"><img src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-calendar.webp" alt width={30} height={30} loading="lazy" decoding="async" /></span>
        ...
        <article className="lvaf-card">
          ...
          <span className="lvaf-ibox" aria-hidden="true"><img src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-cube.webp" alt width={28} height={30} loading="lazy" decoding="async" /></span>
        ...
        <article className="lvaf-card lvaf-card--w1">
          ...
          <span className="lvaf-ibox" aria-hidden="true"><img src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-vault.webp" alt width={30} height={30} loading="lazy" decoding="async" /></span>
        ...
        <article className="lvaf-card lvaf-card--wide">
          ...
          <span className="lvaf-ibox lvaf-ibox--lg" aria-hidden="true"><img src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-retainer.webp" alt width={48} height={50} loading="lazy" decoding="async" /></span>
  ...
  <section className="lvaf-cta" aria-labelledby="lvaf-cta-title">
    ...
    <div className="lvaf-cta-frame">
      <div className="lvaf-cta-card">
        <img className="lvaf-cta-art" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-cta-bg-v2.webp" alt width={1240} height={548} loading="lazy" decoding="async" />
          ...
          <ul className="lvaf-cta-stats">
            <li className="lvaf-cta-stat">
              <span className="lvaf-cta-stat-head">
                <img className="lvaf-cta-stat-icon lvaf-cta-stat-icon--gift" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-gift.webp" alt width={24} height={25} loading="lazy" decoding="async" />
            ...
            <li className="lvaf-cta-stat">
              <span className="lvaf-cta-stat-head">
                <img className="lvaf-cta-stat-icon lvaf-cta-stat-icon--calendar" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-calendar.webp" alt width={21} height={21} loading="lazy" decoding="async" />
            ...
            <li className="lvaf-cta-stat">
              <span className="lvaf-cta-stat-head">
                <img className="lvaf-cta-stat-icon lvaf-cta-stat-icon--vault" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-vault.webp" alt width={22} height={22} loading="lazy" decoding="async" />
            ...
            <li className="lvaf-cta-stat">
              <span className="lvaf-cta-stat-head">
                <img className="lvaf-cta-stat-icon lvaf-cta-stat-icon--retainer" src="https://lvlup.tivaosagencytempdomains.de/wp-content/uploads/2026/08/lvaf-icon-retainer.webp" alt width={23} height={24} loading="lazy" decoding="async" />
